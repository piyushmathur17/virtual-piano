function Restoring() {
    ...
    this.defaults = function () {
        ...
        this.Null("win") ? (n.style.visibility = loc.get("win").split(",")[0] == "hidden" ? "visible" : "hidden", 
            n.style.left = loc.get("win").split(",")[2], n.style.top = loc.get("win").split(",")[3], 
            win_fnc.viewer(loc.get("win").split(",")[1])) : loc.set("win", ["visible", "sheet"]);
